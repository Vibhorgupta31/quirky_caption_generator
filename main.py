...
if image is not None:
	...
	with NamedTemporaryFile(dir='.') as f:
		...
		{"role": "user", "content": f"Write a mix of quirky, funny, and actual music lyrics captions for a social media post. Keep the captions a mix of long and one-to-three-word short ones for the image with {orig_caption}. Suggest 7 top captions"}
		]
		)
